...
{
    /// <inheritdoc />
    public partial class SeedingdatafordfficultiesandRegions : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("38c1b64b-b1fc-40ae-b265-c7c45839fed2"), "Hard" },
                    { new Guid("7433828b-ccd0-4673-9984-9dfda101fc78"), "Easy" },
                    { new Guid("e49ffa8f-c986-4c93-a595-fa19a8d05c2d"), "Medium" }
                });
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "id",
                keyValue: new Guid("38c1b64b-b1fc-40ae-b265-c7c45839fed2"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "id",
                keyValue: new Guid("7433828b-ccd0-4673-9984-9dfda101fc78"));

            migrationBuilder.DeleteData(
                table: "Difficulties",
                keyColumn: "id",
                keyValue: new Guid("e49ffa8f-c986-4c93-a595-fa19a8d05c2d"));
